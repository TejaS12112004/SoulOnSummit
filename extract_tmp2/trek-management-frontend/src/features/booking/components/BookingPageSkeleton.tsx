...
export function BookingPageSkeleton() {
  return (
    <div className="min-h-screen bg-beige" aria-busy="true" aria-label="Loading booking page">
      {/* Header skeleton */}
      <div className="bg-white shadow-card border-b border-white/10 px-6 py-5">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-1 min-w-0 space-y-6">
            ...
            <div className="bg-white shadow-card rounded-2xl border border-white/10 p-5">
            ...
            <div className="bg-white shadow-card rounded-2xl border border-white/10 overflow-hidden">
              {/* Card header */}
          ...
          <div className="hidden lg:block lg:w-[380px] shrink-0">
            <div className="bg-white shadow-card rounded-2xl border border-white/10 p-6 space-y-5">
              {/* Trek summary */}
              <div className="space-y-1.5">
