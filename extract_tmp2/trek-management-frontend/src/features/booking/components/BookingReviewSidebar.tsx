...
export function BookingReviewSidebar({ booking }: BookingReviewSidebarProps) {
  ...
  return (
    <div className="bg-card shadow-card rounded-card border border-border p-6 space-y-5 sticky top-6">
      <div>
      ...
      <div className="flex items-center justify-center gap-2 py-2 px-3 bg-muted rounded-btn border border-border">
