  ...
  return (
    <section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Inclusions */}
        {inclusions.length > 0 && (
          <div className="bg-white shadow-card rounded-xl p-5 border border-green-500/10">
        ...
        {/* Exclusions */}
        {exclusions.length > 0 && (
          <div className="bg-white shadow-card rounded-xl p-5 border border-red-500/10">
