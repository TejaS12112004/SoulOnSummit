        ...
        <div className="text-center max-w-md">
          ...
          <div className="flex items-center justify-center gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-btn bg-accent text-accent-foreground font-semibold text-sm hover:bg-accent/80 transition-colors"
            >
            ...
            <Link
              to={ROUTES.TREKS}
              className="inline-flex items-center px-5 py-2.5 rounded-btn border border-border text-muted-foreground font-semibold text-sm hover:bg-muted hover:text-foreground transition-colors"
            >
              All Treks
            </Link>
          </div>
          ...
          <div className="flex-1 min-w-0 space-y-12">
            ...
            {trek.cancellationPolicy && (
              <section>
                ...
                <div className="bg-card shadow-card rounded-card p-5 border border-border">
