      ...
      {onPageSizeChange && (
        <div className="flex items-center ml-4 gap-2">
          ...
          <select
            ...
            className="h-10 px-3 rounded-xl border border-input bg-transparent text-sm shadow-sm transition-[color,box-shadow] duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-0"
