...
export function TrekCard({
  ...
  return (
    <motion.div
      ...
      {...props}
    >
      <Card className="h-full flex flex-col overflow-hidden rounded-card border-border/40 bg-card text-card-foreground shadow-card transition-all duration-200 ease-out hover:-translate-y-1 hover:shadow-hover cursor-pointer group">
        {/* Cover Image Section */}
