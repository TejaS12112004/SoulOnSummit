...
export function GalleryImage({ image }: GalleryImageProps) {
  ...
  if (image.href) {
    return (
      <a
        ...
        className="group aspect-square rounded-card overflow-hidden bg-image-placeholder relative block"
      >
        {content}
      </a>
    );
  ...
  return (
    <div className="group aspect-square rounded-card overflow-hidden bg-image-placeholder relative">
      {content}
    </div>
  );
}
