...
export function FeatureCard({ feature }: FeatureCardProps) {
  ...
  return (
    <div className="bg-card rounded-card p-6 border border-border transition-all duration-200 ease-out hover:shadow-hover hover:border-primary/50 hover:-translate-y-1">
