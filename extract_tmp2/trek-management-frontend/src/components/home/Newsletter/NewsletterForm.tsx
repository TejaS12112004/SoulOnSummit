      ...
      <div className="flex gap-3 max-w-[460px] mx-auto flex-wrap">
        <div className="flex-1 min-w-[200px]">
          <Input
            ...
            aria-invalid={!!error}
            className={cn(
              "h-12 rounded-btn border-white/10 bg-white/10 text-white placeholder:text-white/45",
        ...
        <Button
          type="submit"
          className="btn-primary px-7 py-3 h-auto rounded-btn shrink-0 text-base"
        >
