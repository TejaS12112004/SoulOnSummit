...
export function MobileMenu({ isScrolled = true }: MobileMenuProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger 
        className={cn(
          "flex lg:hidden p-2 bg-transparent border-none cursor-pointer transition-colors duration-200",
      ...
      <SheetContent side="right" className="w-[300px] sm:w-[380px] flex flex-col pt-12 px-6 pb-6 bg-white border-l border-border">
        ...
        <div className="mt-auto flex flex-col gap-4">
          ...
          <Button 
            className="w-full py-6 text-[0.95rem] btn-primary rounded-[10px]"
            asChild
          >
