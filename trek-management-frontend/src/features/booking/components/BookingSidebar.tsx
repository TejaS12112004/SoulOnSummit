...
export function BookingSidebar({
  ...
  return (
    <Card className="p-6 space-y-6 sticky top-6 shadow-sm border-border/60">
      {/* Trek Summary */}
      <div>
        <p className="text-muted-foreground text-[0.75rem] font-bold uppercase tracking-widest mb-1.5">Trek</p>
        <p className="text-card-foreground font-display font-bold text-[1.1rem] leading-snug">{trek.title}</p>
        <p className="text-muted-foreground text-[0.8rem] font-medium mt-1">
      ...
      <div className="space-y-1.5">
        <p className="text-muted-foreground text-[0.75rem] font-bold uppercase tracking-widest mb-1">Departure</p>
        ...
        {departure.isSoldOut && (
          <p className="text-destructive text-[0.8rem] font-bold">No seats available</p>
        )}
        {departure.isFillingFast && !departure.isSoldOut && (
          <p className="flex items-center gap-1.5 text-destructive bg-destructive/10 px-2 py-1 rounded w-max text-[0.75rem] font-bold uppercase tracking-wider mt-2">
      ...
      <div className="border-t border-border/40 mt-10 pt-8">
        <div className="flex justify-between items-end">
          <span className="text-foreground font-bold text-xl tracking-tight mb-1">Grand Total</span>
          <div className="text-right">
            <span className="text-accent font-bold text-[2.4rem] font-display leading-none tracking-tight">
              ₹{subtotal.toLocaleString('en-IN')}
            </span>
          </div>
        </div>
        <p className="text-right text-[0.75rem] font-medium text-muted-foreground mt-2">Includes all taxes & fees</p>
      </div>
