...
export function BookingTravellerList({ booking }: BookingTravellerListProps) {
  ...
  return (
    <div className="bg-card shadow-sm rounded-2xl border border-border p-6 mb-6">
      ...
      <div className="space-y-4">
        {booking.participants.map((p, index) => (
          <div key={p.id} className="p-4 rounded-xl bg-muted/50 border border-border">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-6 text-sm">
              ...
              {p.medicalConditions && (
                <div className="sm:col-span-2">
                  ...
                  <p className="text-warning bg-warning/15 px-3 py-2 rounded-xl border border-warning/30">
                    {p.medicalConditions}
                  </p>
                </div>
              )}
